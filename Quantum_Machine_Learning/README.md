...
1. Create and activate a Python environment using the provided
   `requirements.txt`, which pins the project to the Qiskit 2.2 release
   series and companion packages:
